...
#End Region
    ...
    '    Public Static Function ExecuteDataset(ByVal connectionString As String, ByVal commandType As CommandType, ByVal commandtext As String) As DataSet
    ...
    '    '/// <returns>a dataset containing the resultset generated by the command</returns>
    '    Public Static Function ExecuteDataset()
